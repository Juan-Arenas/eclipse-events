  ...
  return (
    <section id="finca-terrenito" className="py-12 relative bg-[#0a0a0f] overflow-hidden border-t border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Header Tag - Fade Up */}
        <ScrollReveal direction="fade-up" duration={750}>
        ...
        {/* Confidential Venue Specs & Ticket Unlock Banner - Fade Scale */}
        <ScrollReveal direction="fade-scale" duration={800} delay={80}>
